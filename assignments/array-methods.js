...
// donations need to be changed from USD to Euro.

let euroDonations = [];
runners.map (function(runner){
    euroDonations.push(runner.donation * 0.88)
});
console.log(euroDonations); 

// Problem 3

// because of overattendance, people who donated less than 100 cannot race. Make a list

let smallDonations = [];
smallDonations = runners.filter (runner => runner.donation < 100);
